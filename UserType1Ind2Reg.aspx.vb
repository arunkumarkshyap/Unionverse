Imports UserLibrary
Partial Class UserType1Ind2Reg
    ...
    End Property
    Public Sub LoadData()
        Me.hGroupName.InnerHtml = "Planet II <br />(Individual Sales Agent)"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            If UserID > 0 Then
                ...
                Else
                    IndividualUserType2Regis1.Visible = True
                    If GroupID > 0 Then
                        LoadData()
                        IndividualUserType2Regis1.UserType1ID = GroupID
                        IndividualUserType2Regis1.UserID = UserID
                        IndividualUserType2Regis1.LoadData()
                    End If
                End If
            Else

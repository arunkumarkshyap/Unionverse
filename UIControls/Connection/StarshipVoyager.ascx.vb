...
Partial Class UIControls_StarshipVoyager
    ...
    End Function
    Public Sub LoadData()
        Dim oStarShipVouager As New smt_StarShipVoyager
        Dim Arl As New ArrayList
        If GetUser.UserTypeID <> CommonLibrary.Utility.eUserTypes.IndividualType1 OrElse GetUser.UserTypeID <> CommonLibrary.Utility.eUserTypes.IndividualType2 Then
            Arl = oStarShipVouager.StarShipVoyagerGetByGroupTypeUserID(GetUser.UserID)
        Else
            Arl = oStarShipVouager.StarShipVoyagerGetByEmployeeUserID(GetUser.UserID)
        End If

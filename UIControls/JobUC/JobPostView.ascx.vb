Imports JobLibrary
Partial Class JobUC_JobPostView
    Inherits System.Web.UI.UserControl
    Public Event LoadEdit(ByVal jobID As Integer)
    Public Property JobID() As Integer
        Get
            If Not IsNothing(Request.QueryString("jid")) AndAlso IsNumeric(Request.QueryString("jid")) Then
                Session("jid") = Request.QueryString("jid")
                Return Session("jid")
            End If
            If Not IsNothing(Session("jid")) AndAlso IsNumeric(Session("jid")) Then
                Return Session("jid")
            Else
                Return 0
            End If

...
Partial Class JobUC_StarshipSearch
    ...
    Public Sub LoadResults(Optional ByVal pageNo As Integer = 0)
        ...
        End If
        al = oJob.GetFilteredPaged(UserID, JDataHelper.ePostType.Job, txtKeyword.Text, txtZipCode.Text, radius, icate, iJType, iIndus, iedu, iCareer, iDtFrm, iDtTo, 0, 0, , 0, Me.CountryID, Me.StateID, Me.City, 0, 0, "DatePosted", "Desc")
        If al.Count > 0 Then
    ...
    Protected Sub dgJobs_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dgJobs.ItemCommand
        If e.Item.ItemType = ListItemType.AlternatingItem Or e.Item.ItemType = ListItemType.Item Then
            Response.Redirect(UIHelper.GetUnionVerseBasePathURL & "/Members/uvraise/jobview.aspx?jid=" & e.CommandArgument)

        End If
    End Sub
    Public Shared Function getUserProfileIcon(ByVal userID As Integer) As String
        If userID > 0 Then
            Dim _u1 As New UserLibrary.Users(userID)

...
Imports JobLibrary
Partial Class JobUC_JobRequestAddEdit
    ...
    Public Sub LoadData()
        ...
        If JobID > 0 Then
            ...
            ' Add code to verify that current user is oJob.PosterID else raise error message

            With oJob
                ddlSalary.SelectedValue = .SalaryMin
                txtRadius.Text = .Param2
    ...
    Public Sub Save()
        ...
        If Me.JobID > 0 Then
            ...
            With oJob
                ...
                '-----------------------------------------------------------------------
                .PosterID = Me.UserID
                .SalaryMin = ddlSalary.SelectedValue
                .Param2 = txtRadius.Text
        ...
        Else
            With oJob
                ...
                '-----------------------------------------------------------------------
                .PosterID = Me.UserID
                .JobPostTypeID = JDataHelper.ePostType.iResume
                .ExpiryDate = Date.Now.AddYears(1)
                .SalaryMin = ddlSalary.SelectedValue
                .Param2 = txtRadius.Text
                .ExperienceYr = ddlYear.SelectedValue
                .ExperienceMn = ddlMonth.SelectedValue
    ...
    Public Function Validate() As Boolean
        ...
        If ddlCountry.SelectedValue = 0 Then
            lblError.Text = lblError.Text & "Please select a country. <br />"
        End If
        If ddlState.SelectedValue = 0 Then
            lblError.Text = lblError.Text & "Please select a state. <br />"
        End If
        If IsNothing(txtCity.Text) OrElse txtCity.Text.Trim.Length = 0 Then
            lblError.Text = lblError.Text & "Please enter your city. <br />"
        End If
        If IsNothing(txtZipCode.Text) OrElse txtZipCode.Text.Trim.Length = 0 Then
            lblError.Text = lblError.Text & "Please enter your zip code. <br />"
        End If
        If IsNothing(chkCareerLevel) OrElse chkCareerLevel.SelectedValue = 0 Then
            lblError.Text = lblError.Text & "Please select career level. <br />"
        End If
        If IsNothing(chkEduLevel) OrElse chkEduLevel.SelectedValue = 0 Then
            lblError.Text = lblError.Text & "Please select education level. <br />"
        End If
        If IsNothing(chkCategory) OrElse chkCategory.SelectedValue = 0 Then
            lblError.Text = lblError.Text & "Please select a category. <br />"
        End If
        If IsNothing(chkIndustry) OrElse chkIndustry.SelectedValue = 0 Then
            lblError.Text = lblError.Text & "Please select an industry. <br />"
        End If

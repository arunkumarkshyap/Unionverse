...
Imports UserLibrary
Partial Class UIControls_Poll_PollResultsByFilter
    ...
    End Property
    Public Sub LoadGrid()
        If CurrentUser.UserTypeID = CommonLibrary.Utility.eUserTypes.UserType1 Then
            divAddNewPoll.Visible = True
        Else
            divAddNewPoll.Visible = False
        End If
    ...
    Protected Sub rpPolls_ItemDataBound(sender As Object, e As RepeaterItemEventArgs) Handles rpPolls.ItemDataBound
        If e.Item.ItemType = ListItemType.AlternatingItem OrElse e.Item.ItemType = ListItemType.Item Then
            CType(e.Item.FindControl("PollView"), UIControls_PollView).loadData()
        End If
    End Sub

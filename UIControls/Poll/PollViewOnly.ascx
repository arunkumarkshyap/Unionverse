<%@ Control Language="VB" AutoEventWireup="false" CodeFile="PollViewOnly.ascx.vb" Inherits="UIControls_PollViewOnly" %>
<style>
...
<a href="<%=UIHelper.GetBasePath() & "/Electrons/ElectronView.aspx?PollID=" & PollID.ToString %>"><h1 runat="server" id="hPollQuestion" class="Poll_Heading"></h1></a>

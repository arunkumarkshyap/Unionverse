...
Imports UserLibrary
Partial Class UIControls_Poll_PollsListByFilters
    ...
    Public Sub LoadGrid()
        ...
        Arl = oPoll.GetByFillter(0, 0, ZipCode, City, State, IsUnionVersal, IsProfitSpending, 0, 0, ParentCategoryID, CountryID)
        If Arl.Count > 0 Then
